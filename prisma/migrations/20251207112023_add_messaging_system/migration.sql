-- CreateEnum
CREATE TYPE "Subject" AS ENUM ('MATHEMATICS', 'PHYSICS', 'CHEMISTRY', 'BIOLOGY', 'ENGLISH', 'HISTORY', 'GEOGRAPHY', 'COMPUTER_SCIENCE', 'ECONOMICS','SOCIAL', 'HUMANITIES', 'ARTS', 'ACCOUNTING', 'GENERAL');
